						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Advocate Profile</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">Advocate Profile</h2>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="provider-widget">
								<div class="pro-info-left">
									<div class="provider-img">
										<img src="assets/img/instructors/instructor-thumb-01.jpg" class="img-fluid" alt="User Image">
									</div>
									<div class="pro-info-cont">
										<h4 class="pro-name">David Lee</h4>
										<p class="pro-speciality">B.Tech, Aerospace Engineering</p>
										<p class="pro-department"><img src="assets/img/icon.png" class="img-fluid" alt="Speciality">Instructor</p>
										<div class="rating">
