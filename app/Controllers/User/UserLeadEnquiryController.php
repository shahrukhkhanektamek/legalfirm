...
class UserLeadEnquiryController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'user.lead-enquiry.', 
        'title'=>'Lead Enquiry', 
    ...
    public function load_data()
    {
        ...
        $view = view($this->arr_values['folder_name'].'/table-bike-inquiry',compact('data_list','data'),[],true);
        $responseCode = 200;
