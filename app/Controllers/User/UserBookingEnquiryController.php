...
class UserBookingEnquiryController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'user.booking-enquiry.', 
        'title'=>'Booking Enquiry', 
        'table_name'=>'enquiry_booking',
        'page_title'=>'Booking Enquiry',
        "folder_name"=>'web/account',
        "upload_path"=>'upload/',
    ...
    public function load_data()
    {
        ...
        $view = view($this->arr_values['folder_name'].'/table-bike-booking',compact('data_list','data'),[],true);
        $responseCode = 200;
