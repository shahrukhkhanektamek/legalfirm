...
class VendorLeadEnquiryController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'vendor.lead-enquiry.', 
        'title'=>'Lead Enquiry', 
        'table_name'=>'vendor_enquiry_lead',
        'page_title'=>'Lead Enquiry',
        "folder_name"=>'backend/vendor/enquiry/lead-enquiry',
        "upload_path"=>'upload/',
